...
// useEffect(()=>{
//   setProductHolder(Product.items)
//   sercByName()
// },[])
// useEffect(()=>{
//   sercByName()
...
// console.log(productHolder)
  ...
  <button style={{background:"#FFE484",borderBlockColor:"#563D7C",color:"black"}}>search</button>
</div>
      </div>
    <div className='productsItemCards mt-5 container-fluid d-flex justify-content-center '>
      <div className="row justify-content-center">
      {Product.items.filter((items)=>items.name.toLowerCase().includes(search.toLowerCase())).map((items)=>
